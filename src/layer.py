...
class Layer:
    ...
    :parameter position: The position of the layer(on the top left corner). Needs array in following style: [x, y]
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.x = kwargs.get("position", [0,0])[0]
        self.y = kwargs.get("position", [0,0])[1]
